...
class ARS111IntegratorABstd(DGFSIntegratorAstd):
    ...
    def integrate(self, t, dt, nacptsteps, d_ucoeff):
        sm, explicit, boltz, limit1 = self._sm, self._explicit, self._explicitQ, self._limit1
        moment, updateMoment = sm.moment, sm.updateMomentBDF
        updateDist, consMaxwellian, linear = sm.updateDistBDF, sm.constructMaxwellian, sm.collide
        ...
        # assemble the explicit part with contribution from linear and quadratic operators
...
class ARS111IntegratorABEstd(DGFSIntegratorAstd):
    ...
    def integrate(self, t, dt, nacptsteps, d_ucoeff):
        sm, explicit, boltz, limit1 = self._sm, self._explicit, self._explicitQ, self._limit1
        moment, updateMoment = sm.moment, sm.updateMomentBDF
        updateDistNu, consMaxwellian, linearNu = sm.updateDistNuBDF, sm.constructMaxwellian, sm.collideNu
